...
class TzScriptType:
    ...
    def is_operation_compatible(self, other) -> bool:
        return self.name == other.name
    
    def is_assignable(self, other) -> bool:
        if self.name == TypesNames.IntOrNat:
            return other.name in [TypesNames.Natural, TypesNames.Integer, TypesNames.IntOrNat]
        return self.name == other.name
...
class TzScriptNat(TzScriptType):
    ...
    def is_operation_compatible(self, other: TzScriptType) -> bool:
        return super().is_operation_compatible(other) or other.name == TypesNames.Integer or other.name == TypesNames.IntOrNat
...
class TzScriptInt(TzScriptType):
    ...
    def is_operation_compatible(self, other: TzScriptType) -> bool:
        return super().is_operation_compatible(other) or other.name == TypesNames.Natural or other.name == TypesNames.IntOrNat
...
class TzScriptIntOrNat(TzScriptType):
    ...
    def is_operation_compatible(self, other: TzScriptType) -> bool:            
        return super().is_operation_compatible(other) or other.name == TypesNames.Natural or other.name == TypesNames.Integer or other.name == TypesNames.IntOrNat
