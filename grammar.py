...
class Grammar():
    ...
    def __init__(self):
        ...
        self.symbDict: dict[str, Symbol] = {'$': self.EOF}
    ...
    def AugmentedGrammar(self, force=False):
        if not self.IsAugmentedGrammar or force:
            ...
            assert S is not None, "The grammar must have a start symbol."
...
class Item:
    ...
    def __init__(self, production: Production, pos: int, lookaheads=[]):
